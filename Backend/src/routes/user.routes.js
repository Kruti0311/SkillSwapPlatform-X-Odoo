...
router.route("/search").get(verifyJWT_username, searchUsersBySkill);
router.route("/visibility").patch(verifyJWT_username, updateProfileVisibility);
router.route("/availability").patch(verifyJWT_username, updateAvailability);
router.route("/location").patch(verifyJWT_username, updateLocation);
